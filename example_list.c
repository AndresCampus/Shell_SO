...
/**
 * Programa de ejemplo para mostrar el uso de la API de gestión de trabajos
 * (jobs) definida en job_control.h. Este programa es útil para entender cómo
 * manipular la lista de procesos en segundo plano del shell.
 */
